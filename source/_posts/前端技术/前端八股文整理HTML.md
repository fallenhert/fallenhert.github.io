...
# 盒模型：标准盒模型，怪异盒模型
[CSS盒模型](https://blog.csdn.net/qq_37899792/article/details/90019385)
...
想要切换盒模型，可以通过借用css3的box-sizing属性
...
# 块元素与行内元素
## 块元素
块元素拥有自己的宽高，也就是可以自定义width和height，它可以独占一行高度，一般可以作为其他元素容器，可容纳块元素及行内元素
...
```
# 语义化标签
[什么是HTML语义标签？](https://blog.csdn.net/eeeecw/article/details/80591511)
## 什么是HTML语义化标签
语义化标签旨在让标签具有自己的含义
...
# 伪类和伪元素
[CSS伪类和伪元素的区别](https://juejin.cn/post/7198386916760141883)
...
css2中伪元素和伪类的写法是一致的，都是使用单冒号+名称来表示，**在css3规范中为了清晰的加以区分，推荐使用双冒号标识伪元素**
